...
import dev.leonardo.ocremoteplus.ui.navigation.NavGraph
...
class MainActivity : ComponentActivity() {
    ...
    @Inject
    lateinit var fileRepository: dev.leonardo.ocremoteplus.domain.repository.FileRepository
    ...
    override fun attachBaseContext(newBase: Context) {
        ...
        val languageCode = dev.leonardo.ocremoteplus.data.repository.SettingsDataStore.getStoredLanguage(newBase)
